...
const store = new Vuex.Store({
  state: {
    days: [
      { id: 1, x: 3, y: 3, langs: ["js", "go"] },
      { id: 2, x: 50, y: 70, langs: ["js"] },
      { id: 3, x: 8, y: 70, langs: ["js"] },
      { id: 4, x: 73, y: 70, langs: ["js"] },
      { id: 5, x: 10, y: 20, langs: ["js"] },
      { id: 6, x: 63, y: 4, langs: ["js"] },
      { id: 7, x: 40, y: 30, langs: ["js"] },
      { id: 8, x: 90, y: 15, langs: ["js"] },
      { id: 9, x: 70, y: 30, langs: ["js"] },
